      ...
      <div className="section-container relative z-10 py-28 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-10 items-center min-h-screen lg:min-h-0">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              <span className="text-xs text-gray-400 dark:text-gray-600 uppercase tracking-widest font-mono">
                Follow
              </span>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            ...
            >
              ...
              <div
                ...
                style={{ inset: "-52px" }}
              >
                <OrbitItem angle={0} radius={148} delay={0}>
                  ⚛️
                </OrbitItem>
                <OrbitItem angle={72} radius={148} delay={0}>
                  🟢
                </OrbitItem>
                <OrbitItem angle={144} radius={148} delay={0}>
                  🐍
                </OrbitItem>
                <OrbitItem angle={216} radius={148} delay={0}>
                  🍃
                </OrbitItem>
                <OrbitItem angle={288} radius={148} delay={0}>
                  🐙
                </OrbitItem>
              </div>
